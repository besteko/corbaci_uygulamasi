...
class MainActivity4 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var corbacesit = findViewById<TextView>(R.id.corbacesit)
        ...
        corbacesit.text =  "$alinancorba Çorbası"
        ...
        var besegecis = Intent(applicationContext, MainActivity5::class.java)
        ...
        tuzbar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(p0: SeekBar?, p1: Int, p2: Boolean) {
                if (p1 == 2) {
                    ...
                    val uyari1 = AlertDialog.Builder(this@MainActivity4)
        ...
        siparisver.setOnClickListener {
            ...
            uyari2.setIcon(R.drawable.bklogo)
